...
const activeMachineImage = {
  expressions:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/machine-active.svg",
  animals:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/server-machine-animals.svg",
};

const activeSingularRouteImage = {
  expressions:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expression-route-active.svg",
  animals:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/animal-route-active.svg",
};

const activePluralRouteImage = {
  expressions:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expressions-route-active.svg",
  animals:
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/animals-route-active.svg",
};
  ...
  $.ajax("/", {
    success: function () {
      ...
      if (
        ...
        $("#expression-route").attr("src") ===
          "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expression-route-inactive.svg"
      ) {
    ...
    error: function (xhr) {
      if (xhr.status !== 404) {
        ...
        $("#expressions-route").attr(
          "src",
          "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expressions-route-inactive.svg"
        );
      }
    },
  });
...
function activateMachine() {
  ...
  $("#beaker").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/beaker-active-neutral.svg"
  );

  if (
    $("#lightbulb").attr("src") ===
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-inactive.svg"
  ) {
    $("#lightbulb").attr(
      "src",
      "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-active.svg"
    );
  }
}
...
function deactivateMachine() {
  ...
  $("#server-machine").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/server-machine-inactive.svg"
  );
  $("#lightbulb").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-inactive.svg"
  ...
  $("#beaker").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/beaker-inactive.svg"
  );
  $("#code-number").text("");
...
function triggerExpressionRequest() {
  ...
  $("#expression-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expression-route-pending.svg"
  );
...
function triggerExpressionsRequest() {
  ...
  $("#expressions-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expressions-route-pending.svg"
  );
  $("#code-number").text("");
  $("#code-description").text("");
  clearExpressionText();
...
function animateMachine(animationDelay) {
  $("#beaker").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/beaker-pending.svg"
  );
  $("#lightbulb").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-pending.svg"
  );
  $("#sliders")
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/sliders-active-1.svg"
      );
      next();
    })
    ...
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/sliders-active-2.svg"
      );
      next();
    })
    .delay(animationDelay)
    ...
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/sliders-inactive.svg"
      );
      next();
    });
  $("#buttons")
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/buttons-active-1.svg"
      );
      next();
    })
    .delay(animationDelay)
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/buttons-active-2.svg"
      );
      next();
    })
    .delay(animationDelay)
    ...
    .queue(function (next) {
      $(this).attr(
        "src",
        "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/buttons-inactive.svg"
      );
      next();
    });
}
...
function animateGoodExpressionRequest(statusCode, statusDescription, response) {
  ...
  $("#expression-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expression-route-green.svg"
  );
...
function animateGoodExpressionsRequest(
  ...
  $("#expressions-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expressions-route-green.svg"
  );
...
function animateGoodRequest(statusCode, statusDescription) {
  $("#lightbulb").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-green.svg"
  );
...
function animateBadExpressionRequest(statusCode, statusDescription) {
  ...
  $("#expression-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expression-route-red.svg"
  );
}
...
function animateBadExpressionsRequest(statusCode, statusDescription) {
  ...
  $("#expressions-route").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/expressions-route-red.svg"
  );
}
...
function animateBadRequest(statusCode, statusDescription) {
  $("#lightbulb").attr(
    "src",
    "https://s3.amazonaws.com/codecademy-content/courses/learn-express-routes/lightbulb-red.svg"
  );
